...
|  LANGUAGEID      |   Número       |No                 |  Idioma con que se registrará la sesión. Las posibles opciones son: <br> Inglés <br> Español <br> Portugués <br>Si no se provee, por defecto se registra en inglés. |
|   CONSOLEID      |   Número       |No                 |                               |
...
|   DEVICEBRANDID  |   Número       |No                 |  <br> Marca del dispositivo desde el que se inicia sesión. Las posibles opciones son: <br> 1. Android <br> 2. iOS|
